...
static const CanMessageId s_telemetry_can_filters[] = {
  SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE1_STATUS_A,          SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE1_STATUS_B,   SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE1_STATUS_C,
  SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE1_STATUS_D,          SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE1_STATUS_E,   SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE1_STATUS_F,
  SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE2_STATUS_A,          SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE2_STATUS_B,   SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE2_STATUS_C,
  SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE2_STATUS_D,          SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE2_STATUS_E,   SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_AFE2_STATUS_F,
  SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_REAR_CONTROLLER_STATUS, SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_BATTERY_STATS_A, SYSTEM_CAN_MESSAGE_REAR_CONTROLLER_BATTERY_STATS_B,
