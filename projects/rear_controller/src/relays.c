...
//Array of relay pins
static const GpioAddress *s_relays_sense[NUM_REAR_RELAYS] = {
  &s_relay_storage.pos_relay_sense,
  &s_relay_storage.neg_relay_sense,
  &s_relay_storage.solar_relay_sense,
  &s_relay_storage.motor_relay_sense
};
//Array of enable pins
static const GpioAddress *s_relays_enable[NUM_REAR_RELAYS] = {
  &s_relay_storage.pos_relay_en, 
  &s_relay_storage.neg_relay_en, 
  &s_relay_storage.solar_relay_en,
  &s_relay_storage.motor_relay_en
};
...
StatusCode relay_verify_states(void) {
  ...
  if ((s_rear_controller_storage->pos_relay_closed && 
      ...
      (!s_rear_controller_storage->pos_relay_closed && 
       (gpio_get_state(&s_relay_storage.pos_relay_sense) != GPIO_STATE_LOW))) {
  ...
  if ((s_rear_controller_storage->neg_relay_closed && 
       (gpio_get_state(&s_relay_storage.neg_relay_sense) != GPIO_STATE_HIGH)) || 
      (!s_rear_controller_storage->neg_relay_closed && 
       (gpio_get_state(&s_relay_storage.neg_relay_sense) != GPIO_STATE_LOW))) {
  ...
  if ((s_rear_controller_storage->solar_relay_closed && 
       (gpio_get_state(&s_relay_storage.solar_relay_sense) != GPIO_STATE_HIGH)) || 
      (!s_rear_controller_storage->solar_relay_closed && 
       (gpio_get_state(&s_relay_storage.solar_relay_sense) != GPIO_STATE_LOW))) {
  ...
  if ((s_rear_controller_storage->motor_relay_closed && 
       (gpio_get_state(&s_relay_storage.motor_relay_sense) != GPIO_STATE_HIGH)) || 
      (!s_rear_controller_storage->motor_relay_closed && 
       (gpio_get_state(&s_relay_storage.motor_relay_sense) != GPIO_STATE_LOW))) {
