...
#define CELL_OVERVOLTAGE 41500 // Absolute threshold 4.2
#define CELL_UNDERVOLTAGE 27000 // Absolute threshold 2.5 
#define CELL_UNBALANCED 5000
#define CELL_MAX_TEMPERATURE_DISCHARGE 50 //Max 60
#define CELL_MAX_TEMPERATURE_CHARGE 50 //Max 60
