 ...
 * @details HAL expects page number relative to start of flash
 * @param   addr Address to be converted to page number
 * @return  Page number
 */
#define BOOTLOADER_ADDR_TO_PAGE(addr) (((uintptr_t)(addr) - (uintptr_t)FLASH_START_ADDRESS_LINKERSCRIPT) / BOOTLOADER_PAGE_BYTES)
 ...
 */
#define BOOTLOADER_PAGE_TO_ADDR(page) ((uintptr_t)(page) * (uintptr_t)BOOTLOADER_PAGE_BYTES + (uintptr_t)FLASH_START_ADDRESS_LINKERSCRIPT)
