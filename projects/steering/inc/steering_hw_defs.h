...
#define STEERING_DISPLAY_LTDC_CLOCK { .port = GPIO_PORT_A, .pin = 4 }

/** @brief  LTDC horizontal sync pin */
#define STEERING_DISPLAY_LTDC_HSYNC { .port = GPIO_PORT_C, .pin = 2 }

/** @brief  LTDC vertical sync pin */
#define STEERING_DISPLAY_LTDC_VSYNC { .port = GPIO_PORT_B, .pin = 11 }

/** @brief  LTDC data enable pin */
#define STEERING_DISPLAY_LTDC_DE { .port = GPIO_PORT_C, .pin = 0 }
