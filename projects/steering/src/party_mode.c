...
StatusCode party_mode_run(void) {
  ...
  bool both_pressed = (steering_storage->button_manager->buttons[STEERING_BUTTON_RIGHT_LIGHT].state == BUTTON_PRESSED &&
                       steering_storage->button_manager->buttons[STEERING_BUTTON_LEFT_LIGHT].state == BUTTON_PRESSED);
