...
static BootCanTiming s_timing[NUM_BOOT_CAN_BITRATES] = { [BOOT_CAN_BITRATE_125KBPS] = { .prescaler = 40, .bs1 = CAN_BS1_12TQ, .bs2 = CAN_BS2_1TQ },
...
FotaError can_bootloader_init(void) {
  Boot_CanSettings settings = { .bitrate = BOOT_CAN_BITRATE_500KBPS, .loopback = false, .silent = false };
