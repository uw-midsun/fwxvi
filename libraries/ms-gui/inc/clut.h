...
typedef enum {
  ...
  GUI_COLOR_REGEN_BRAKE_FILL,
  GUI_COLOR_BRAKE_FILL,
  GUI_COLOR_SOC_FILL,
  GUI_COLOR_LABEL_BORDER,
  GUI_COLOR_CELL_VOLTAGE_LOW,
  GUI_COLOR_CELL_VOLTAGE_HIGH,
  GUI_COLOR_BPS_FAULT_TEXT,
  GUI_COLOR_BPS_FAULT_BACKGROUND,
  GUI_COLOR_BPS_FAULT_NONLIVE_BACKGROUND,
  GUI_COLOR_SPEEDOMETER_RING_FILL,
  NUM_GUI_COLOR_IDS,
} GuiColorId;
