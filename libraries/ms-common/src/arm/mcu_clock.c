 ...
 * @file   mcu_clock.c
 *
 * @brief  System clock configuration, isolated from mcu_init so a minimal client (the
 *         bootloader) can bring the PLL up without pulling in GPIO and printf retargeting
 *
 * @date   2024-10-27
