...
/* Lookup table for adc ranks (+ 1 for ADC_INVALID_RANK) */
static const uint32_t s_hal_rank_nums[NUM_ADC_RANKS + 1] = { ADC_INVALID_RANK,    ADC_REGULAR_RANK_1,  ADC_REGULAR_RANK_2,  ADC_REGULAR_RANK_3,  ADC_REGULAR_RANK_4,  ADC_REGULAR_RANK_5,
...
/* Lookup table for adc channels */
static const uint32_t s_hal_channel_nums[NUM_ADC_CHANNELS] = { ADC_CHANNEL_0,  ADC_CHANNEL_1,  ADC_CHANNEL_2,  ADC_CHANNEL_3,  ADC_CHANNEL_4,  ADC_CHANNEL_5,  ADC_CHANNEL_6,
