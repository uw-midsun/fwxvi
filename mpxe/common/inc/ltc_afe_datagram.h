...
class LTC_AFE {
  public: 
    static constexpr uint8_t LTC_AFE_MAX_DEVICES                 = 3;   /**< Max number of AFE devices supported */
    static constexpr uint8_t LTC_AFE_MAX_CELLS_PER_DEVICE        = 12;  /**< Max cell channels per AFE device */
    static constexpr uint8_t LTC_AFE_MAX_THERMISTORS_PER_DEVICE  = 8;   /**< Max thermistors per AFE device */

    static constexpr uint8_t LTC_AFE_MAX_CELLS       = LTC_AFE_MAX_DEVICES * LTC_AFE_MAX_CELLS_PER_DEVICE;        /**< Total cell channels supported */
    static constexpr uint8_t LTC_AFE_MAX_THERMISTORS = LTC_AFE_MAX_DEVICES * LTC_AFE_MAX_THERMISTORS_PER_DEVICE;  /**< Total thermistor channels supported */
    ...
    struct Payload{
        ...
        uint16_t cell_voltages[LTC_AFE_MAX_CELLS];      /**< Cell voltages for all devices */
        uint16_t aux_voltages[LTC_AFE_MAX_THERMISTORS]; /**< Aux voltages for all devices */
    };

    /**
     * @brief Constructs a LTC_AFE object with provided payload data
     * 
     */
    explicit LTC_AFE(Payload &data);

    /**
     * @brief Default constructor for LTC_AFE object
     */
    LTC_AFE() = default; 
     ...
     * @param index Global cell index (0, ..., LTC_AFE_MAX_CELLS-1)
     ...
     * @param index Global aux index (0, ..., LTC_AFE_MAX_THERMISTORS-1)
     * @param voltage Voltage in mV
     */
    void setAuxVoltage(uint16_t index, uint16_t voltage);

    /**
     * @brief Set the Device Cells Voltage
     * @param device_index Index of device (0, ..., LTC_AFE_MAX_DEVICES)
     * @param voltage voltage in mV
     */
    void setDeviceCellsVoltage(uint16_t device_index, uint16_t voltage);

    /**
     * @brief Set the Device Aux Voltage
     * @param device_index Index of device (0, ..., LTC_AFE_MAX_DEVICES)
     * @param voltage voltage in mV
     */
    void setDeviceAuxsVoltage(uint16_t device_index, uint16_t voltage);

    /**
     * @brief Set cell voltages for all devices
     * @param voltage 
     */
    void setCellPackVoltage(uint16_t voltage); 

    /**
     * @brief Set aux voltages for all devices
     * @param voltage 
     */
    void setAuxPackVoltage(uint16_t voltage); 
     ...
     * @param deviceIndex Index of the device (0 .. LTC_AFE_MAX_DEVICES-1)
