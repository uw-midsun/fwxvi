...
struct mc_status {
  ...
  nlohmann::json to_json() const {
    return {
      {"limit_bitset_l", limit_bitset_l},
      {"error_bitset_l", error_bitset_l},
      {"limit_bitset_r", limit_bitset_r},
      {"error_bitset_r", error_bitset_r},
      {"board_fault_bitset", board_fault_bitset},
      {"overtemp_bitset", overtemp_bitset},
...
struct motor_controller_vc {
  ...
  nlohmann::json to_json() const {
    return {
      {"mc_voltage_l", mc_voltage_l},
      {"mc_current_l", mc_current_l},
      {"mc_voltage_r", mc_voltage_r},
      {"mc_current_r", mc_current_r}
    };
  }
...
struct motor_sink_temps {
  ...
  nlohmann::json to_json() const {
    return {
      {"motor_temp_l", motor_temp_l},
      {"heatsink_temp_l", heatsink_temp_l},
      {"motor_temp_r", motor_temp_r},
      {"heatsink_temp_r", heatsink_temp_r}
    };
  }
...
struct dsp_board_temps {
  ...
  nlohmann::json to_json() const {
    return {
      {"dsp_temp_l", dsp_temp_l},
      {"dsp_temp_r", dsp_temp_r}
    };
  }
