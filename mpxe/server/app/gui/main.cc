...
static QString simulationJsonBaseDir() {
  return QDir(QCoreApplication::applicationDirPath())
           .absoluteFilePath(QStringLiteral("../../../../mpxe/Simulation_JSON"));
}
...
int main(int argc, char *argv[])
{
  ...
  QObject::connect(watcher, SIGNAL(clientsListChanged(QStringList)),
                   &win,    SLOT(onClientsListChanged(QStringList)));
