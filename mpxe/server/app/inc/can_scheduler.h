...
#define NUM_MEDIUM_CYCLE_MESSAGES 16U /**< Number of medium cycle messages */
#define NUM_SLOW_CYCLE_MESSAGES 5U    /**< Number of slow cycle messages */

/**
 * @brief   Fast cycle Broadcast Manager message for the Linux Kernel
 * @note    kernel expects bcm_msg_head then can_frame(s).
 */
struct {
  struct bcm_msg_head msg_head;                    /**< Broadcast Manager message head, before frame */
  struct can_frame frame[NUM_FAST_CYCLE_MESSAGES]; /**< CAN message frames scheduled for fast cycle */
} canFastCycleBCM;
...
class CanScheduler {
 private:
  ...
  static const constexpr unsigned int SLOW_TELEMETRY_TELEMETRY_FRAME_INDEX = 4U;                    /**< Broadcast Manager telemetry to Frame index mapping */
 ...
 public:
   ...
   */
  void update_rear_controller_status_triggers(uint16_t triggers_value);
  /**
