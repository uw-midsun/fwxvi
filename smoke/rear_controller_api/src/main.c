...
static const char* print_state_str(RearControllerState state){
    switch (state)
    {
        case REAR_CONTROLLER_STATE_IDLE : return "IDLE";
        case REAR_CONTROLLER_STATE_DRIVE : return "DRIVE";
        case REAR_CONTROLLER_STATE_CHARGE : return "CHARGE";
        case REAR_CONTROLLER_STATE_FAULT : return "FAULT";
...
static void log_status(void){
    ...
    LOG_DEBUG("State: %s | Relays: [POS: %d] [NEG: %d] [SOLAR: %d] [MOTOR: %d]\n",
            ...
            s_rear_storage.pos_relay_closed,
            s_rear_storage.neg_relay_closed,
            s_rear_storage.solar_relay_closed,
            s_rear_storage.motor_relay_closed);
}
